function onCreate()
	...
	makeAnimatedLuaSprite('ruria', 'stage2/backcrowd-extra', -2475, -65);
	setLuaSpriteScrollFactor('ruria', 1.0, 1.0);
	scaleObject('ruria', 2.12, 2.12);
	
	makeAnimatedLuaSprite('publi', 'stage2/frontcrowd-extra', -2450, 600);
    ...
    addAnimationByPrefix('light','idle','win',9, true);
    addLuaSprite('ruria', false);

    addAnimationByPrefix('ruria','bg1','bg1',52, true);
    addLuaSprite('stage', false);
    addLuaSprite('bocina', false);
    addAnimationByPrefix('bocina','idle','speaker',26, true);
    addLuaSprite('bocina2', false);
    addAnimationByPrefix('bocina2','idle','speaker',26, true);
    
    addLuaSprite('bocina1', false);
    addAnimationByPrefix('bocina1','idle','speaker',26, true);
    addLuaSprite('bocina3', false);
    addAnimationByPrefix('bocina3','idle','speaker',26, true);
     addLuaSprite('publi', true);
    addAnimationByPrefix('publi','bg3','bg3',52, true);
